...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {
      ...
      case IntegralListEntity:
        return integralListEntityFromJson(data as IntegralListEntity, json)
            as T;
      ...
      case HomeArticleDatasTags:
        return homeArticleDatasTagsFromJson(data as HomeArticleDatasTags, json)
            as T;
      case SystemTreeEntity:
        return systemTreeEntityFromJson(data as SystemTreeEntity, json) as T;
      case SystemTreeChildren:
        return systemTreeChildrenFromJson(data as SystemTreeChildren, json)
            as T;
      case LoginEntity:
  ...
  static M _getListChildType<M>(List data) {
    if (<BannerDataEntity>[] is M) {
      return data
          .map<BannerDataEntity>((e) => BannerDataEntity().fromJson(e))
          .toList() as M;
    }
    if (<IntegralEntity>[] is M) {
      return data
          .map<IntegralEntity>((e) => IntegralEntity().fromJson(e))
          .toList() as M;
    }
    if (<RankListEntity>[] is M) {
      return data
          .map<RankListEntity>((e) => RankListEntity().fromJson(e))
          .toList() as M;
    }
    if (<RankListDatas>[] is M) {
      return data
          .map<RankListDatas>((e) => RankListDatas().fromJson(e))
          .toList() as M;
    }
    if (<ProjectTreeEntity>[] is M) {
      return data
          .map<ProjectTreeEntity>((e) => ProjectTreeEntity().fromJson(e))
          .toList() as M;
    }
    if (<CollectEntity>[] is M) {
      return data
          .map<CollectEntity>((e) => CollectEntity().fromJson(e))
          .toList() as M;
    }
    ...
    if (<IntegralListEntity>[] is M) {
      return data
          .map<IntegralListEntity>((e) => IntegralListEntity().fromJson(e))
          .toList() as M;
    }
    if (<IntegralListDatas>[] is M) {
      return data
          .map<IntegralListDatas>((e) => IntegralListDatas().fromJson(e))
          .toList() as M;
    }
    ...
    if (<SystemTreeEntity>[] is M) {
      return data
          .map<SystemTreeEntity>((e) => SystemTreeEntity().fromJson(e))
          .toList() as M;
    }
    if (<SystemTreeChildren>[] is M) {
      return data
          .map<SystemTreeChildren>((e) => SystemTreeChildren().fromJson(e))
          .toList() as M;
    }
    if (<LoginEntity>[] is M) {
